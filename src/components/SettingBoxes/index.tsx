...
const SettingBoxes = () => {
  ...
  const handleSaveFile = async () => {
    if (!selectedFile) {
      toast.error("You Should Select a Image");
      return;
    }
    if (selectedFile) {
      try {
  ...
  return (
    <>
          ...
          <div className="rounded-[10px] border border-stroke bg-white shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
            ...
            <div className="p-7">
              <form>
                ...
                <div className="mb-5.5 w-full flex flex-row gap-8">
                  <div className="w-1/2">
                    {" "}
                    <label
                      className="mb-1 block text-body-sm font-medium text-dark dark:text-white"
            ...
            <div className="p-7">
              <form>
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button
                    className="flex items-center justify-center rounded-[7px] bg-primary px-6 py-[7px] font-medium text-gray-2 hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                    type="button"
                    onClick={handleSaveFile}
                    disabled={!selectedFile || loading3}
                  >
      ...
      <ConfirmationModal message="Are you sure you want to delete this photo?" />
      <ToastContainer
