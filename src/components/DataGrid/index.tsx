...
const DataGrid: React.FC<DataGridProps> = ({ title, data, className }) => {
  const getIconColor = (status?: string | number | null) => {
  ...
  return (
    <div className="bg-white dark:bg-[#122031] shadow-lg rounded-lg p-6 mb-6">
      <h2 className="text-2xl font-bold mb-6 dark:text-[#E2E8F0] flex items-center">
        <span className="text-primary text-3xl mr-2">📡</span> {title}
      </h2>
